...
(defun what-object(features)
  ...
  (roslisp:call-service "/svm_classifier/classify_service" 'knowledge_msgs-srv:Classify
                        :features features))
...
(defun is-object(objectString features)
  ...
  (roslisp:with-fields
    ...
    (if
     (string= label objectString)
     (return-from is-object T)
     (return-from is-object nil))))
...
(defun place-object (gripper frame-id x-coordinate y-coordinate)
  (roslisp:call-service "/place_object/place" 'knowledge_msgs-srv:PlaceObject
                        :gripper gripper
                        :frame_id frame-id
...
(Defun how-To-Pick-Objects (object) 
  (roslisp:call-service "/knowledge_grasp/knowledge_grasp" 'knowledge_msgs-srv:GraspIndividual
                        :object_label object))
